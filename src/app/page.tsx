...
export default function LandingPage() {
  ...
  <div id="products" data-section="products">
      ...
      useInvertedBackground={false}
      products={[
        { id: "1", name: "Engrais organique", price: "45.00$", variant: "10kg", imageSrc: "http://img.b2bpic.net/free-photo/top-view-container-leaves_23-2148883456.jpg" },
        { id: "2", name: "Semence gazon", price: "35.00$", variant: "5kg", imageSrc: "http://img.b2bpic.net/free-photo/gardener-repotting-houseplant_53876-127240.jpg" },
        { id: "3", name: "Paillis de cèdre", price: "12.00$ le sac", variant: "Sac 50L", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DlQE9j5RwG1pF8sleGqSn5dJUd/uploaded-1778858805642-6ewe00cl.png" },
        { id: "4", name: "Compost premium", price: "8.00$ / 20kg ", variant: "Sac 20kg", imageSrc: "http://img.b2bpic.net/free-photo/creative-flat-lay-gardening-concept_23-2148195487.jpg" },
      ]}
  ...
  <div id="pricing" data-section="pricing">
      ...
      plans={[
        {
          id: "basic",          badge: "Découverte",          price: "59$ / visite",          subtitle: "Pour l'entretien occasionnel",          features: ["Tonte soignée", "Délimitation des bordures", "Support prioritaire"],
          buttons: [{ text: "Commander", href: "#contact" }]
        },
        {
          id: "pro",          badge: "Populaire",          price: "99$ / mois",          subtitle: "La tranquillité totale",          features: ["Tonte bimensuelle", "Taille de haies incluse", "Fertilisation saisonnière", "Nettoyage débris"],
          buttons: [{ text: "Commander", href: "#contact" }]
        },
        {
